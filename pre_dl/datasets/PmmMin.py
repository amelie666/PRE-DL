...
class PmmMin(CiMissDownloader):
    ...
    def __init__(self):
        ...
        data_params = {'interfaceId': 'getCawnEleByTime',
                       ...
                       'elements': 'Station_Id_C,Lat,Lon,Year,Mon,Day,Hour,Min,PM2p5_Densty,PM25_MID',
    ...
    def _interp(self, lat_min=0, lat_max=70, lon_min=60, lon_max=140, method='linear'):
        ...
        valid3 = df['Lat'] != '999999'
        df_x = df[valid1 & valid2 & valid3]
...
class PmmMinTimeRange(CiMissDownloader):
    content = None

    def __init__(self):
        super(PmmMinTimeRange, self).__init__()
        data_params = {'interfaceId': 'getCawnEleByTimeRange',
                       'dataCode': 'CAWN_CHN_PMM_MIN',
                       'elements': 'Station_Id_C,Lat,Lon,Year,Mon,Day,Hour,Min,PM2p5_Densty,PM25_MID',
                       'orderby': 'Station_ID_C:ASC',
                       'dataFormat': 'json'
    ...
    def fetch(self, timeRange: str):
        """

        :param datetime:  example: 20190101000000
        """
        self.params.update({'timeRange': timeRange})
        r = requests.get(self.cimiss_url, params=self.params)
        self.content = r.json()
